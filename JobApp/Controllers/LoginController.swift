...
class LoginController: UIViewController {
    ...
    let loginRegisterButton: UIButton = {
        ...
        button.setTitle("Registrazione", for: .normal)
    ...
    @objc func handleRegister(){
        ...
        let ref = Database.database().reference(fromURL: "https://fastjob-ceb5a.firebaseio.com/")
    ...
    let loginRegisterSegmentControl : UISegmentedControl = {
        let sc = UISegmentedControl(items: ["Login", "Registrazione"])
